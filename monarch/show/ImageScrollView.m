...
#if TILE_IMAGES
    [self displayTiledImageNamed:self.currentImageName/*_ImageNameAtIndex(index)*/ size:self.currentImageSize/*_ImageSizeAtIndex(index)*/];
#else
...
////
////    return data;
//    return [NXDetailPageViewController imageIndexData];
//}
...
////    });
////    return count;
//    return [NXDetailPageViewController imageCount];
//}
...
//    return [NXDetailPageViewController imageNameAtIndex:index];
//}
...
//    return [NXDetailPageViewController imageSizeAtIndex:index];
//}
